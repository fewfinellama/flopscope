...
export async function openAgentDrawer(did) {
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="min-w-0 flex-1 space-y-1">
          ...
          <div class="flex flex-wrap items-center gap-2 mt-2">
            <button id="drawer-copy-did-btn" class="btn-interactive flex-shrink-0 whitespace-nowrap px-3 py-1.5 bg-cyan-50 dark:bg-cyan-950/60 text-cyan-700 dark:text-[#00c2ff] border border-cyan-200 dark:border-cyan-800/80 rounded-xl text-xs font-mono font-bold flex items-center gap-1.5 transition-colors">
            ...
            <button id="drawer-watch-did-btn" class="btn-interactive flex-shrink-0 whitespace-nowrap px-3 py-1.5 ${state.watchedDids.has(did) ? 'bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800/80' : 'bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-800'} border rounded-xl text-xs font-mono font-bold flex items-center gap-1.5 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition-colors">
  ...
  watchBtn.onclick = () => {
    if (state.watchedDids.has(did)) {
      ...
      watchBtn.className = "btn-interactive flex-shrink-0 whitespace-nowrap px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800/80 border rounded-xl text-xs font-mono font-bold flex items-center gap-1.5 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition-colors";
